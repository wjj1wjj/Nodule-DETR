...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--modelname', default='dn_dab_deformable_detr', type=str)
    ...
    parser.add_argument('--coco_path', default="XX") # change the path of dataset
    ...
    # Traing utils
    parser.add_argument('--output_dir', default='XX', help='path where to save, empty for no saving')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            args.clip_max_norm, wo_class_error=wo_class_error, lr_scheduler=lr_scheduler, args=args, logger = logger)
